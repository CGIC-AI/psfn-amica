...
export const defaults = {
  ...
  psfn_assistant_name: process.env.NEXT_PUBLIC_PSFN_ASSISTANT_NAME ?? defaultName,
  psfn_user_name: process.env.NEXT_PUBLIC_PSFN_USER_NAME ?? 'You',
  ...
  amica_life_enabled: process.env.NEXT_PUBLIC_AMICA_LIFE_ENABLED ?? runtimeDefault('true', 'true'),
  amica_life_mode: process.env.NEXT_PUBLIC_AMICA_LIFE_MODE ?? runtimeDefault('full', 'animation_only'),
